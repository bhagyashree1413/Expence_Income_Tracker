...
public class ExpensesIncomesTracker extends JFrame {
    ...
    public ExpensesIncomesTracker(){
        ...
        // Initialize the table modelvand balance variable.
        balance = 0.0;
        ...
        // Set the layout of the main ftame and add components to appropriate positions.
        add(inputPanel, BorderLayout.NORTH);
        add(scrollpane, BorderLayout.CENTER);
        add(bottomPanel, BorderLayout.SOUTH);
         
        // Set the title, default close opertaion, and visibility of the main frame.
